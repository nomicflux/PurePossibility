...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];                 
  var passAlongTo = function (dictEq) {
      return function (dictFoldable) {
          return function (slots) {
              return function (query) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Foldable.traverse_(Halogen_Query_HalogenM.applicativeHalogenM)(dictFoldable)(action)(slots))(function (v) {
  ...
  exports["passAlongTo"] = passAlongTo;
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];                 
  var worldRadius = 25;
  var selfRelationRadius = Data_Int.toNumber(worldRadius) * 0.75;
  var arrowHeadLength = Data_Int.toNumber(worldRadius) * 0.25;
  exports["worldRadius"] = worldRadius;
  exports["selfRelationRadius"] = selfRelationRadius;
...
(function(exports) {
  ...
  var Data_Semiring = PS["Data.Semiring"];
  var Prelude = PS["Prelude"];                 
  var subOffset = function (coordinates) {
  ...
  exports["subOffset"] = subOffset;
  exports["addOffset"] = addOffset;
})(PS["Component.Common.Coordinates"] = PS["Component.Common.Coordinates"] || {});
(function(exports) {
...
})(PS["Component.Common.MouseOffset"] = PS["Component.Common.MouseOffset"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
    "use strict";
  var $foreign = PS["Component.Common.MouseOffset"];
  var Component_Common_Coordinates = PS["Component.Common.Coordinates"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad = PS["Control.Monad"];
  var Data_Function = PS["Data.Function"];
  ...
  var getMaybeOffset = function (v) {
      if (v instanceof Data_Maybe.Just) {
          return $foreign.getOffset(v.value0);
      };
      if (v instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(Effect.applicativeEffect)(Component_Common_Coordinates.noOffset);
      };
      throw new Error("Failed pattern match at Component.Common.MouseOffset line 19, column 1 - line 19, column 49: " + [ v.constructor.name ]);
  };
  var getCoordinates = function (mouseEvent) {
      return function (el) {
          var y = Web_UIEvent_MouseEvent.clientY(mouseEvent);
          var x = Web_UIEvent_MouseEvent.clientX(mouseEvent);
          var coordinates = {
              x: Data_Int.toNumber(x),
              y: Data_Int.toNumber(y)
          };
          return function __do() {
              var v = getMaybeOffset(el)();
              return Component_Common_Coordinates.subOffset(coordinates)(v);
          };
      };
  };
  exports["getMaybeOffset"] = getMaybeOffset;
...
(function(exports) {
  ...
  var y = function ($2) {
      return Halogen_HTML_Properties.attr("y")(Data_Show.show(Data_Show.showInt)($2));
  };
  var x2 = function ($3) {
  ...
  var x = function ($5) {
      return Halogen_HTML_Properties.attr("x")(Data_Show.show(Data_Show.showInt)($5));
  };
  ...
  var circlePath = function (fromx) {
      return function (fromy) {
          return function (radius) {
              return function (tox) {
                  return function (toy) {
                      var path = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")([ "M", Data_Show.show(Data_Show.showNumber)(fromx), Data_Show.show(Data_Show.showNumber)(fromy), "A", Data_Show.show(Data_Show.showNumber)(radius), Data_Show.show(Data_Show.showNumber)(radius), "0", "1", "1", Data_Show.show(Data_Show.showNumber)(tox), Data_Show.show(Data_Show.showNumber)(toy) ]);
                      return Halogen_HTML_Properties.attr("d")(path);
                  };
              };
          };
      };
...
(function(exports) {
  ...
  var $$Math = PS["Math"];
  var Prelude = PS["Prelude"];                 
  var renderSelfRelation = function (class_) {
      return function (c) {
          var numRadius = Data_Int.toNumber(Component_Common_Constants.worldRadius);
          var offsetX = numRadius * (1.0 / 2.0);
          var offsetY = numRadius * ($$Math.sqrt(3.0) / 2.0);
          return Component_Common_SVG.arc([ Component_Common_SVG.circlePath(c.x + offsetX)(c.y + offsetY)(Component_Common_Constants.selfRelationRadius)(c.x - offsetX)(c.y + offsetY), Component_Common_SVG.class_("relation self-relation relation-" + class_) ]);
      };
  };
  var mkLine = function (from) {
      return function (to) {
          return function (class_) {
              return Component_Common_SVG.line([ Component_Common_SVG.x1(Data_Int.round(from.x)), Component_Common_SVG.y1(Data_Int.round(from.y)), Component_Common_SVG.x2(Data_Int.round(to.x)), Component_Common_SVG.y2(Data_Int.round(to.y)), Component_Common_SVG.class_(class_) ]);
          };
      };
  };
  var getCircleOffset = function (angle) {
  ...
  var renderArrow = function (class_) {
      return function (f) {
          return function (t) {
              var classes = "relation relation-arrow relation-" + class_;
              var angle = getAngle(f)(t);
              var leftAngle = angle + 0.75 * $$Math.pi;
              var leftOffset = getCircleOffset(leftAngle)(Component_Common_Constants.arrowHeadLength);
              var rightAngle = leftAngle + $$Math.pi / 2.0;
              var rightOffset = getCircleOffset(rightAngle)(Component_Common_Constants.arrowHeadLength);
              var mainOffset = getCircleOffset(angle)(Data_Int.toNumber(Component_Common_Constants.worldRadius));
              var onCircle = Component_Common_Coordinates.subOffset(t)(mainOffset);
              return [ mkLine(onCircle)(Component_Common_Coordinates.addOffset(onCircle)(leftOffset))(classes), mkLine(onCircle)(Component_Common_Coordinates.addOffset(onCircle)(rightOffset))(classes) ];
          };
      };
  };
  var renderOtherRelation = function (class_) {
      return function (f) {
          return function (t) {
              var angle = getAngle(f)(t);
              var offset = getCircleOffset(angle)(Data_Int.toNumber(Component_Common_Constants.worldRadius));
              var onFromCircle = Component_Common_Coordinates.addOffset(f)(offset);
              var onToCircle = Component_Common_Coordinates.subOffset(t)(offset);
              return mkLine(onFromCircle)(onToCircle)("relation other-relation relation-" + class_);
          };
      };
  };
  var renderRelations = function (class_) {
      return function (from) {
          return function (to) {
              var eqCoord = function (f) {
                  return function (t) {
                      return f.x === t.x && f.y === t.y;
                  };
              };
              return Data_Array.fromFoldable(Data_List_Types.foldableList)(Control_Bind.bind(Data_List_Types.bindList)(from)(function (v) {
                  return Control_Bind.bind(Data_List_Types.bindList)(to)(function (v1) {
                      var v2 = eqCoord(v)(v1);
                      if (v2) {
                          return Data_List.singleton(renderSelfRelation(class_)(v));
                      };
                      if (!v2) {
                          return new Data_List_Types.Cons(renderOtherRelation(class_)(v)(v1), Data_List.fromFoldable(Data_Foldable.foldableArray)(renderArrow(class_)(v)(v1)));
                      };
                      throw new Error("Failed pattern match at Component.Relation line 49, column 5 - line 51, column 123: " + [ v2.constructor.name ]);
                  });
              }));
          };
      };
  ...
  exports["getCircleOffset"] = getCircleOffset;
  exports["mkLine"] = mkLine;
  exports["renderRelations"] = renderRelations;
  exports["renderArrow"] = renderArrow;
  exports["renderSelfRelation"] = renderSelfRelation;
  exports["renderOtherRelation"] = renderOtherRelation;
})(PS["Component.Relation"] = PS["Component.Relation"] || {});
(function(exports) {
    "use strict";
  var Component_Common_Constants = PS["Component.Common.Constants"];
  var Component_Common_Coordinates = PS["Component.Common.Coordinates"];
  ...
  var RelationsChanged = (function () {
      function RelationsChanged(value0) {
          this.value0 = value0;
      };
      RelationsChanged.create = function (value0) {
          return new RelationsChanged(value0);
      };
      return RelationsChanged;
  })();
  var ChangePosition = (function () {
      function ChangePosition(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangePosition.create = function (value0) {
          return function (value1) {
              return new ChangePosition(value0, value1);
          };
      };
      return ChangePosition;
  })();
  var GetCoordinates = (function () {
      function GetCoordinates(value0) {
          this.value0 = value0;
      };
      GetCoordinates.create = function (value0) {
          return new GetCoordinates(value0);
      };
      return GetCoordinates;
  })();
  var AddRelation = (function () {
      function AddRelation(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      AddRelation.create = function (value0) {
          return function (value1) {
              return new AddRelation(value0, value1);
          };
      };
      return AddRelation;
  })();
  var RemoveRelations = (function () {
      function RemoveRelations(value0) {
          this.value0 = value0;
      };
      RemoveRelations.create = function (value0) {
          return new RemoveRelations(value0);
      };
      return RemoveRelations;
  })();
  var ChangeColor = (function () {
      function ChangeColor(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeColor.create = function (value0) {
          return function (value1) {
              return new ChangeColor(value0, value1);
          };
      };
      return ChangeColor;
  })();
  var Clicked = (function () {
      function Clicked(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Clicked.create = function (value0) {
          return function (value1) {
              return new Clicked(value0, value1);
          };
      };
      return Clicked;
  })();
  ...
  var render = function (state) {
      var boxRadius = state.r + offset | 0;
      return Component_Common_SVG.svg([  ])([ Component_Common_SVG.circle([ Component_Common_SVG.cx(state.x), Component_Common_SVG.cy(state.y), Component_Common_SVG.r(state.r), Component_Common_SVG.stroke(state.color), Component_Common_SVG.class_("world world-base") ]), Component_Common_SVG.text([ Component_Common_SVG.stroke("black"), Component_Common_SVG.x(state.x - 3 | 0), Component_Common_SVG.y((state.y - state.r | 0) - 2 | 0), Component_Common_SVG.class_("world-id") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state.id)) ]) ]);
  };
  var initialState = function (id) {
      return {
          ...
          x: 0,
          y: 0,
          r: Component_Common_Constants.worldRadius,
          color: "black",
          relations: Data_Set.empty
      };
  };
  var getCoordinates = function (state) {
      return {
          x: Data_Int.toNumber(state.x),
          y: Data_Int.toNumber(state.y)
      };
  };
  var $$eval = function (v) {
      if (v instanceof ChangePosition) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              $17.x = Data_Int.round(v.value0.x);
              $17.y = Data_Int.round(v.value0.y);
              return $17;
          }))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new PositionChanged(v.value0)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
              });
          });
      };
      if (v instanceof GetCoordinates) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(getCoordinates))(function ($49) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0($49));
          });
      };
      if (v instanceof AddRelation) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.relations;
          }))(function (v1) {
              var newRels = Data_Set.union(Data_Ord.ordInt)(v1)(v.value0);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $24.relations = newRels;
                  return $24;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new RelationsChanged(newRels)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(Data_Unit.unit));
                  });
              });
          });
      };
      if (v instanceof RemoveRelations) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              var $29 = {};
              for (var $30 in v1) {
              ...
              $29.relations = Data_Set.empty;
              return $29;
          }))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new RelationsChanged(Data_Set.empty)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0(Data_Unit.unit));
              });
          });
      };
      if (v instanceof ChangeColor) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              var $33 = {};
              for (var $34 in v1) {
      ...
      if (v instanceof Clicked) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
              var minY = Data_Int.toNumber(v1.y - v1.r | 0);
              var minX = Data_Int.toNumber(v1.x - v1.r | 0);
              var maxY = Data_Int.toNumber(v1.y + v1.r | 0);
              var maxX = Data_Int.toNumber(v1.x + v1.r | 0);
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1(v.value0.x <= maxX && (v.value0.x >= minX && (v.value0.y <= maxY && v.value0.y >= minY))));
          });
      };
      throw new Error("Failed pattern match at Component.World line 86, column 8 - line 115, column 115: " + [ v.constructor.name ]);
  };
  ...
  exports["Slot"] = Slot;
  exports["PositionChanged"] = PositionChanged;
  exports["RelationsChanged"] = RelationsChanged;
  exports["component"] = component;
...
})(PS["Component.World"] = PS["Component.World"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Data_Tuple = PS["Data.Tuple"];
  var Prelude = PS["Prelude"];                 
  var updateRelation = function (f) {
      return function (a) {
          return function (b) {
              return function (rels) {
                  return Data_Array.modifyAtIndices(Data_Foldable.foldableArray)([ a ])(function (r) {
                      return Data_Array.modifyAtIndices(Data_Foldable.foldableArray)([ b ])(f)(r);
                  })(rels);
              };
          };
      };
  };
  var setBlank = function (fromId) {
      return function (rels) {
          var size = Data_Array.length(rels);
          var newRow = Data_Array.replicate(size + 1 | 0)(false);
          return Data_Array.updateAtIndices(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple(fromId, newRow) ])(rels);
      };
  };
  var rmVariable = function (id) {
      return function (rels) {
          return Data_Functor.map(Data_Functor.functorArray)(Data_Array.updateAtIndices(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple(id, false) ]))(setBlank(id)(rels));
      };
  };
  var numVars = Data_Array.length;
  var newRelations = function (fromRels) {
      return function (toRels) {
          var zippedOnce = Data_Array.zip(fromRels)(toRels);
          var zippedTwice = Data_Functor.map(Data_Functor.functorArray)(function (v) {
              return Data_Array.zip(v.value0)(v.value1);
          })(zippedOnce);
          return Data_Functor.map(Data_Functor.functorArray)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
              var $11 = v.value0 === v.value1;
              if ($11) {
                  return false;
              };
              return v.value1;
  ...
  var mkRelationMap = function (n) {
      return Data_Array.replicate(n)(Data_Array.replicate(n)(false));
  };
  var getRelationsFrom = function (fromId) {
      return function (rels) {
          return Data_Maybe.maybe([  ])(function (row) {
          ...
          })(Data_Array.index(rels)(fromId));
      };
  };                                                                                                    
  var empty = mkRelationMap(0);
  var addVariable = function (relMap) {
      var size = Data_Array.length(relMap);
      var newRow = Data_Array.replicate(size + 1 | 0)(false);
      var addedToRows = Data_Functor.map(Data_Functor.functorArray)(Data_Function.flip(Data_Array.snoc)(false))(relMap);
      return Data_Array.snoc(addedToRows)(newRow);
  };
  var addRelation = updateRelation(Data_Function["const"](true));
  var addRelations = function (dictFoldable) {
      return function (fromId) {
          return function (toIds) {
              return function (rels) {
                  return Data_Foldable.foldl(dictFoldable)(function (acc) {
                      return function (toId) {
                          return addRelation(fromId)(toId)(acc);
                      };
                  })(rels)(toIds);
              };
          };
  ...
  var replaceRelations = function (dictFoldable) {
      return function (fromId) {
          return function (toIds) {
              return function (rels) {
                  return addRelations(dictFoldable)(fromId)(toIds)(setBlank(fromId)(rels));
              };
          };
      };
  };
  var addRelationsTo = function (dictFoldable) {
      return function (fromIds) {
          return function (toId) {
              return function (rels) {
                  return Data_Foldable.foldl(dictFoldable)(function (acc) {
                      return function (fromId) {
  ...
  exports["mkRelationMap"] = mkRelationMap;
  exports["empty"] = empty;
  exports["numVars"] = numVars;
  exports["addVariable"] = addVariable;
  exports["rmVariable"] = rmVariable;
  exports["addRelation"] = addRelation;
  exports["addRelations"] = addRelations;
  exports["addRelationsTo"] = addRelationsTo;
  exports["replaceRelations"] = replaceRelations;
  exports["getRelationsFrom"] = getRelationsFrom;
  exports["newRelations"] = newRelations;
})(PS["Logic.RelationMap"] = PS["Logic.RelationMap"] || {});
(function(exports) {
    "use strict";
  var Data_Array = PS["Data.Array"];
  var Data_Foldable = PS["Data.Foldable"];
  ...
  var Data_List_Types = PS["Data.List.Types"];
  var Data_Ring = PS["Data.Ring"];
  var Logic_RelationMap = PS["Logic.RelationMap"];
  var Prelude = PS["Prelude"];                 
  var varRange = function (rels) {
      return Data_List.range(0)(Logic_RelationMap.numVars(rels) - 1 | 0);
  };
  var transitive$prime = function (rels) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
          return function ($$var) {
              return Logic_RelationMap.addRelations(Data_Foldable.foldableArray)($$var)(Data_Array.concatMap(function (v) {
                  return Logic_RelationMap.getRelationsFrom(v)(rels);
              })(Logic_RelationMap.getRelationsFrom($$var)(rels)))(acc);
          };
      })(rels)(varRange(rels));
  };
  var transitive = function (rels) {
      return Data_Function.applyN(transitive$prime)(Logic_RelationMap.numVars(rels) - 1 | 0)(rels);
  };
  var symmetric = function (rels) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
          return function ($$var) {
              return Logic_RelationMap.addRelationsTo(Data_Foldable.foldableArray)(Logic_RelationMap.getRelationsFrom($$var)(rels))($$var)(acc);
          };
      })(rels)(varRange(rels));
  };
  var reflexive = function (rels) {
      return Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
          return function ($$var) {
              return Logic_RelationMap.addRelation($$var)($$var)(acc);
          };
      })(rels)(varRange(rels));
  };
  exports["reflexive"] = reflexive;
  exports["symmetric"] = symmetric;
  exports["transitive"] = transitive;
})(PS["Logic.Properties"] = PS["Logic.Properties"] || {});
(function(exports) {
    "use strict";
  var Component_Common_Communication = PS["Component.Common.Communication"];
  var Component_Common_Coordinates = PS["Component.Common.Coordinates"];
  var Component_Common_MouseOffset = PS["Component.Common.MouseOffset"];
  var Component_Common_SVG = PS["Component.Common.SVG"];
  var Component_Relation = PS["Component.Relation"];
  var Component_World = PS["Component.World"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad_State_Class = PS["Control.Monad.State.Class"];
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Halogen_Query_InputF = PS["Halogen.Query.InputF"];
  var Logic_Properties = PS["Logic.Properties"];
  var Logic_RelationMap = PS["Logic.RelationMap"];
  var Prelude = PS["Prelude"];
  var Web_UIEvent_MouseEvent = PS["Web.UIEvent.MouseEvent"];                 
  var Reflexive = (function () {
      function Reflexive() {

      };
      Reflexive.value = new Reflexive();
      return Reflexive;
  })();
  ...
  var Transitive = (function () {
      ...
      Transitive.value = new Transitive();
      return Transitive;
  })();
  var AddingWorlds = (function () {
      function AddingWorlds() {

      };
      AddingWorlds.value = new AddingWorlds();
      return AddingWorlds;
  })();
  var AddingRelations = (function () {
      function AddingRelations() {

      };
      AddingRelations.value = new AddingRelations();
      return AddingRelations;
  })();
  var Click = (function () {
  ...
  var ChangeAttribute = (function () {
      function ChangeAttribute(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ChangeAttribute.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ChangeAttribute(value0, value1, value2);
              };
          };
      };
      return ChangeAttribute;
  })();
  var ChangeCanvasState = (function () {
      function ChangeCanvasState(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      ChangeCanvasState.create = function (value0) {
          return function (value1) {
              return new ChangeCanvasState(value0, value1);
          };
      };
      return ChangeCanvasState;
  })();
  var HandleWorld = (function () {
      function HandleWorld(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      HandleWorld.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new HandleWorld(value0, value1, value2);
              };
          };
      };
      return HandleWorld;
  })();
  var rightClicked = function (mouseEvent) {
      var x = Web_UIEvent_MouseEvent.button(mouseEvent);
      return x === 2 || x === 3;
  };
  var renderWorld = function (id) {
      return Halogen_HTML.slot(new Component_World.Slot(id))(Component_World.component)(id)(Halogen_HTML_Events.input(HandleWorld.create(id)));
  };
  var keyPressed = function (mouseEvent) {
      return Web_UIEvent_MouseEvent.altKey(mouseEvent) || (Web_UIEvent_MouseEvent.shiftKey(mouseEvent) || Web_UIEvent_MouseEvent.metaKey(mouseEvent));
  };
  var initialState = {
      worlds: Data_Set.empty,
      maxId: Data_Maybe.Nothing.value,
      canvasState: AddingWorlds.value,
      selectedWorlds: Data_Set.empty,
      draggingWorlds: Data_Set.empty,
      mouseAt: Data_List_Types.Nil.value,
      coordinateMap: Data_Map_Internal.empty,
      relationMap: Logic_RelationMap.empty,
      systemAttributes: Data_Set.empty
  };
  var getWorldCoordinates = function (worlds) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
          return v.coordinateMap;
      }))(function (v) {
          var ids = Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordInt)(worlds);
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Map_Internal.filterKeys(Data_Ord.ordInt)(function (id) {
              return Data_Set.member(Data_Ord.ordInt)(id)(ids);
          })(v));
      });
  };
  var getRelCoordinates = function (coords) {
      return function (rels) {
          return function (id) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordInt)(id)(coords))(function (v) {
                  var fromRels = Logic_RelationMap.getRelationsFrom(id)(rels);
                  var toCoords = Data_Foldable.foldl(Data_List_Types.foldableList)(function (acc) {
                      return function (i) {
                          return new Data_List_Types.Cons(Data_Map_Internal.lookup(Data_Ord.ordInt)(i)(coords), acc);
                      };
                  })(Data_List_Types.Nil.value)(Data_List.fromFoldable(Data_Foldable.foldableArray)(fromRels));
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(new Data_Tuple.Tuple(v, Data_List.catMaybes(toCoords)));
              });
          };
      };
  };
  var renderRelationsFrom = function (coords) {
      return function (class_) {
          return function (rels) {
              return function (w) {
                  return Data_Maybe.maybe([  ])(function (v) {
                      return Component_Relation.renderRelations(class_)(Data_List.singleton(v.value0))(v.value1);
                  })(getRelCoordinates(coords)(rels)(w));
              };
          };
      };
  };
  var getNextId = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
      var allIds = Data_Maybe.maybe(Data_Set.empty)(function ($161) {
          return Data_Set.fromFoldable(Data_Foldable.foldableArray)(Data_Ord.ordInt)(Data_Array.range(0)($161));
      })(v.maxId);
      var missing = Data_Set.difference(Data_Ord.ordInt)(allIds)(v.worlds);
      var v1 = Data_Set.isEmpty(missing);
      if (!v1) {
          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Maybe.fromMaybe(0)(Data_Set.findMin(missing)));
      };
      if (v1) {
          var newVars = Logic_RelationMap.addVariable(v.relationMap);
          var newMax = Data_Maybe.maybe(0)(function (v2) {
              return v2 + 1 | 0;
          })(v.maxId);
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
              var $74 = {};
              ...
              $74.maxId = new Data_Maybe.Just(newMax);
              $74.relationMap = newVars;
              return $74;
          }))(function () {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(newMax);
          });
      };
      throw new Error("Failed pattern match at Component.Worlds line 218, column 3 - line 226, column 18: " + [ v1.constructor.name ]);
  });
  var fromMaybeM = function (def) {
      return Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Maybe.fromMaybe(def));
  };
  var eqSystemAttribute = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Reflexive && y instanceof Reflexive) {
              return true;
          };
          if (x instanceof Symmetric && y instanceof Symmetric) {
              return true;
          };
          if (x instanceof Transitive && y instanceof Transitive) {
              return true;
          };
          return false;
      };
  });
  var ordSystemAttribute = new Data_Ord.Ord(function () {
      return eqSystemAttribute;
  }, function (x) {
      return function (y) {
          if (x instanceof Reflexive && y instanceof Reflexive) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Reflexive) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Reflexive) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Symmetric && y instanceof Symmetric) {
              return Data_Ordering.EQ.value;
          };
          if (x instanceof Symmetric) {
              return Data_Ordering.LT.value;
          };
          if (y instanceof Symmetric) {
              return Data_Ordering.GT.value;
          };
          if (x instanceof Transitive && y instanceof Transitive) {
              return Data_Ordering.EQ.value;
          };
          throw new Error("Failed pattern match at Component.Worlds line 33, column 8 - line 33, column 58: " + [ x.constructor.name, y.constructor.name ]);
      };
  });
  var eqCanvasState = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof AddingWorlds && y instanceof AddingWorlds) {
              return true;
          };
          if (x instanceof AddingRelations && y instanceof AddingRelations) {
              return true;
          };
          return false;
      };
  });
  var canvasRef = "world-canvas";
  var clickedWorlds = function (mouseEvent) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.getRef(canvasRef))(function ($162) {
          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Common_MouseOffset.getCoordinates(mouseEvent)($162));
      }))(function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function ($163) {
              return Data_List.fromFoldable(Data_Set.foldableSet)((function (v1) {
                  return v1.worlds;
              })($163));
          }))(function (v1) {
              var clicked = function (id) {
                  return Halogen_Query.query(Component_World.eqSlot)(new Component_World.Slot(id))(Halogen_Query.request(Component_World.Clicked.create(v)));
              };
              return Data_List.filterM(Halogen_Query_HalogenM.monadHalogenM)(function ($164) {
                  return fromMaybeM(false)(clicked($164));
              })(v1);
          });
      });
  };
  var $$eval = function (v) {
      if (v instanceof Click) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.canvasState;
          }))(function (v1) {
              if (v1 instanceof AddingWorlds) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      var v3 = keyPressed(v.value0) || rightClicked(v.value0);
                      if (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(clickedWorlds(v.value0))(function (v4) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v5) {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v6) {
                                      return v6.relationMap;
                                  }))(function (v6) {
                                      var removed = Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordInt)(v4);
                                      var newWorlds = Data_Set.difference(Data_Ord.ordInt)(v2)(removed);
                                      var newRMap = Data_Foldable.foldl(Data_List_Types.foldableList)(Data_Function.flip(Logic_RelationMap.rmVariable))(v6)(v4);
                                      var newCMap = Data_Foldable.foldl(Data_List_Types.foldableList)(Data_Function.flip(Data_Map_Internal["delete"](Data_Ord.ordInt)))(v5)(v4);
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v7) {
                                          var $92 = {};
                                          for (var $93 in v7) {
                                              if ({}.hasOwnProperty.call(v7, $93)) {
                                                  $92[$93] = v7[$93];
                                              };
                                          };
                                          $92.worlds = newWorlds;
                                          $92.coordinateMap = newCMap;
                                          $92.relationMap = newRMap;
                                          return $92;
                                      }))(function () {
                      ...
                      if (!v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.getRef(canvasRef))(function ($165) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Common_MouseOffset.getCoordinates(v.value0)($165));
                          }))(function (v4) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getNextId)(function (v5) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v6) {
                                      return v6.coordinateMap;
                                  }))(function (v6) {
                                      var newMap = Data_Map_Internal.insert(Data_Ord.ordInt)(v5)(v4)(v6);
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v7) {
                                          var $98 = {};
                                          for (var $99 in v7) {
                                              if ({}.hasOwnProperty.call(v7, $99)) {
                                                  $98[$99] = v7[$99];
                                              };
                                          };
                                          $98.worlds = Data_Set.insert(Data_Ord.ordInt)(v5)(v2);
                                          return $98;
                                      }))(function () {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(Component_World.eqSlot)(new Component_World.Slot(v5))(Halogen_Query.request(Component_World.ChangePosition.create(v4))))(function (v7) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                          });
                                      });
                                  });
                      ...
                      throw new Error("Failed pattern match at Component.Worlds line 242, column 7 - line 263, column 20: " + [ v3.constructor.name ]);
                  });
              };
              if (v1 instanceof AddingRelations) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(clickedWorlds(v.value0))(function (v2) {
                      var v3 = keyPressed(v.value0) || rightClicked(v.value0);
                      if (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Common_Communication.passAlongTo(Component_World.eqSlot)(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Component_World.Slot.create)(v2))(Component_World.RemoveRelations.create))(function (v4) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      };
                      if (!v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              return v4.selectedWorlds;
                          }))(function (v4) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var v5 = Data_Set.isEmpty(v4);
                                  if (v5) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(clickedWorlds(v.value0))(function (v6) {
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(getWorldCoordinates(v6))(function (v7) {
                                              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v8) {
                                                  var $107 = {};
                                                  for (var $108 in v8) {
                                                      if ({}.hasOwnProperty.call(v8, $108)) {
                                                          $107[$108] = v8[$108];
                                                      };
                                                  };
                                                  $107.selectedWorlds = Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordInt)(v6);
                                                  $107.mouseAt = Data_Map_Internal.values(v7);
                                                  return $107;
                                              });
                                          });
                                      });
                                  ...
                                  if (!v5) {
                                      var relTo = Data_Set.fromFoldable(Data_List_Types.foldableList)(Data_Ord.ordInt)(v2);
                                      var relFrom = Data_List.fromFoldable(Data_Set.foldableSet)(v4);
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Component_Common_Communication.passAlongTo(Component_World.eqSlot)(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Component_World.Slot.create)(relFrom))(Component_World.AddRelation.create(relTo)))(function (v6) {
                                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v7) {
                                              var $110 = {};
                                              for (var $111 in v7) {
                                                  if ({}.hasOwnProperty.call(v7, $111)) {
                                                      $110[$111] = v7[$111];
                                                  };
                                              };
                                              $110.selectedWorlds = Data_Set.empty;
                                              return $110;
                                          });
                                      });
                                  };
                                  throw new Error("Failed pattern match at Component.Worlds line 272, column 11 - line 284, column 69: " + [ v5.constructor.name ]);
                              })())(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
                      };
                      throw new Error("Failed pattern match at Component.Worlds line 266, column 7 - line 285, column 20: " + [ v3.constructor.name ]);
                  });
              };
              throw new Error("Failed pattern match at Component.Worlds line 239, column 30 - line 285, column 20: " + [ v1.constructor.name ]);
          });
      };
      if (v instanceof MouseMove) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.selectedWorlds;
          }))(function (v1) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.getRef(canvasRef))(function ($166) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Component_Common_MouseOffset.getCoordinates(v.value0)($166));
              }))(function (v2) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v3 = Data_Set.isEmpty(v1);
                      if (v3) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_List.singleton(v2));
                      };
                      if (!v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(clickedWorlds(v.value0))(getWorldCoordinates))(function (v4) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)((function () {
                                  var v5 = Data_Map_Internal.values(v4);
                                  if (v5 instanceof Data_List_Types.Nil) {
                                      return Data_List.singleton(v2);
                                  };
                                  return v5;
                              })());
                          });
                      };
                      throw new Error("Failed pattern match at Component.Worlds line 290, column 18 - line 297, column 25: " + [ v3.constructor.name ]);
                  })())(function (v3) {
      ...
      if (v instanceof ChangeCanvasState) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              var $126 = {};
              for (var $127 in v1) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  if (v.value1) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $133.systemAttributes = Data_Set.insert(ordSystemAttribute)(v.value0)(v1);
                          return $133;
                      });
                  };
                  if (!v.value1) {
                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $136.systemAttributes = Data_Set["delete"](ordSystemAttribute)(v.value0)(v1);
                          return $136;
                      });
                  };
                  throw new Error("Failed pattern match at Component.Worlds line 305, column 3 - line 307, column 70: " + [ v.value1.constructor.name ]);
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value2);
              });
          });
      };
      if (v instanceof HandleWorld && v.value1 instanceof Component_World.PositionChanged) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.coordinateMap;
          }))(function (v1) {
              var newMap = Data_Map_Internal.insert(Data_Ord.ordInt)(v.value0)(v.value1.value0)(v1);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $143 = {};
                  for (var $144 in v2) {
      ...
      if (v instanceof HandleWorld && v.value1 instanceof Component_World.RelationsChanged) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              return v1.relationMap;
          }))(function (v1) {
              var newMap = Logic_RelationMap.replaceRelations(Data_Set.foldableSet)(v.value0)(v.value1.value0)(v1);
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  var $151 = {};
                  for (var $152 in v2) {
      ...
      throw new Error("Failed pattern match at Component.Worlds line 237, column 1 - line 237, column 65: " + [ v.constructor.name ]);
  };
  var applyAttributes = function (attrs) {
      var applyTransitive = function (r) {
          var $158 = Data_Set.member(ordSystemAttribute)(Transitive.value)(attrs);
          if ($158) {
              return Logic_Properties.transitive(r);
          };
          return r;
      };
      var applySymmetric = function (r) {
          var $159 = Data_Set.member(ordSystemAttribute)(Symmetric.value)(attrs);
          if ($159) {
              return Logic_Properties.symmetric(r);
          };
          return r;
      };
      var applyReflexive = function (r) {
          var $160 = Data_Set.member(ordSystemAttribute)(Reflexive.value)(attrs);
          if ($160) {
              return Logic_Properties.reflexive(r);
          };
          return r;
      };
      return function ($167) {
          return applyTransitive(applySymmetric(applyReflexive($167)));
      };
  };
  var render = function (state) {
      var renderCanvas = function (worlds) {
          var relWorlds = Data_Array.fromFoldable(Data_Set.foldableSet)(state.worlds);
          var genRels = applyAttributes(state.systemAttributes)(state.relationMap);
          var justNew = Logic_RelationMap.newRelations(state.relationMap)(genRels);
          var generatedRelations = Data_Array.concatMap(renderRelationsFrom(state.coordinateMap)("generated")(justNew))(relWorlds);
          var existingRelations = Data_Array.concatMap(renderRelationsFrom(state.coordinateMap)("selected")(state.relationMap))(relWorlds);
          var addingFromCoords = Data_List.catMaybes(Data_Functor.map(Data_List_Types.functorList)(Data_Function.flip(Data_Map_Internal.lookup(Data_Ord.ordInt))(state.coordinateMap))(Data_List.fromFoldable(Data_Set.foldableSet)(state.selectedWorlds)));
          var addingRelations = Component_Relation.renderRelations("adding")(addingFromCoords)(state.mouseAt);
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.ref(canvasRef), Halogen_HTML_Properties.class_("pure-u-3-4 world-canvas") ])([ Component_Common_SVG.svg([ Component_Common_SVG.width(1000), Component_Common_SVG.height(1000), Component_Common_SVG.viewBox("0 0 1000 1000"), Component_Common_SVG.class_("world-svg"), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input(Click.create)), Halogen_HTML_Events.onMouseMove(Halogen_HTML_Events.input(MouseMove.create)) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(renderWorld)(worlds))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(addingRelations)(Data_Semigroup.append(Data_Semigroup.semigroupArray)(existingRelations)(generatedRelations)))) ]);
      };
      var mkCheckbox = function (text) {
          return function (query) {
              return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.class_("attr-checkbox"), Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputCheckbox.value), Halogen_HTML_Events.onChecked(Halogen_HTML_Events.input(query)), Halogen_HTML_Properties.title(text) ]), Halogen_HTML_Elements.label_([ Halogen_HTML_Core.text(text) ]) ]);
          };
      };
      ...
      var renderSidebar = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-u-1-4 sidebar") ])([ mkButton("Add / Remove Worlds")("secondary")(Data_Eq.eq(eqCanvasState)(state.canvasState)(AddingWorlds.value))(ChangeCanvasState.create(AddingWorlds.value)), mkButton("Add / Remove Relations")("success")(Data_Eq.eq(eqCanvasState)(state.canvasState)(AddingRelations.value))(ChangeCanvasState.create(AddingRelations.value)), Halogen_HTML_Elements.form([ Halogen_HTML_Properties.class_("pure-form") ])([ mkCheckbox("Reflexive")(ChangeAttribute.create(Reflexive.value)), mkCheckbox("Symmetric")(ChangeAttribute.create(Symmetric.value)), mkCheckbox("Transitive")(ChangeAttribute.create(Transitive.value)) ]) ]);
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("pure-g") ])([ renderSidebar, renderCanvas(Data_Array.fromFoldable(Data_Set.foldableSet)(state.worlds)) ]);
  };
  var component = Halogen_Component.parentComponent(Component_World.ordSlot)({
  ...
  exports["Symmetric"] = Symmetric;
  exports["Transitive"] = Transitive;
  exports["AddingWorlds"] = AddingWorlds;
  exports["AddingRelations"] = AddingRelations;
  exports["initialState"] = initialState;
  exports["Click"] = Click;
  exports["MouseMove"] = MouseMove;
  exports["ChangeAttribute"] = ChangeAttribute;
  exports["ChangeCanvasState"] = ChangeCanvasState;
  exports["HandleWorld"] = HandleWorld;
  exports["component"] = component;
  exports["renderWorld"] = renderWorld;
  exports["canvasRef"] = canvasRef;
  exports["render"] = render;
  exports["applyAttributes"] = applyAttributes;
  exports["renderRelationsFrom"] = renderRelationsFrom;
  exports["getRelCoordinates"] = getRelCoordinates;
  exports["fromMaybeM"] = fromMaybeM;
  exports["clickedWorlds"] = clickedWorlds;
  exports["getWorldCoordinates"] = getWorldCoordinates;
  exports["getNextId"] = getNextId;
  exports["keyPressed"] = keyPressed;
  exports["rightClicked"] = rightClicked;
  exports["eqSystemAttribute"] = eqSystemAttribute;
  exports["ordSystemAttribute"] = ordSystemAttribute;
  exports["eqCanvasState"] = eqCanvasState;
})(PS["Component.Worlds"] = PS["Component.Worlds"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Control_Monad_Error_Class = PS["Control.Monad.Error.Class"];
...
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var Component_Worlds = PS["Component.Worlds"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Data_Unit = PS["Data.Unit"];
  var Effect = PS["Effect"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Component_Worlds.component)(Data_Unit.unit)(v))(function (v1) {
