...
(function(exports) {
  ...
  var renderSelfRelation = function (class_) {
      return function (c) {
          ...
          return HalogenHelpers_SVG.arc([ HalogenHelpers_SVG.circlePath(c.x + offsetX)(c.y + offsetY)(Component_Common_Constants.selfRelationRadius)(c.x - offsetX)(c.y + offsetY), HalogenHelpers_SVG.class_("relation self-relation relation-" + class_) ]);
      };
  };
  var mkLine = function (from) {
      return function (to) {
          return function (class_) {
              return HalogenHelpers_SVG.line([ HalogenHelpers_SVG.x1(Data_Int.round(from.x)), HalogenHelpers_SVG.y1(Data_Int.round(from.y)), HalogenHelpers_SVG.x2(Data_Int.round(to.x)), HalogenHelpers_SVG.y2(Data_Int.round(to.y)), HalogenHelpers_SVG.class_(class_) ]);
          };
      };
  };
  ...
  var renderArrow = function (class_) {
      return function (f) {
          return function (t) {
              ...
              var onCircle = HalogenHelpers_Coordinates.subOffset(t)(mainOffset);
              return [ mkLine(onCircle)(HalogenHelpers_Coordinates.addOffset(onCircle)(leftOffset))(classes), mkLine(onCircle)(HalogenHelpers_Coordinates.addOffset(onCircle)(rightOffset))(classes) ];
          };
      };
  };
  var renderOtherRelation = function (class_) {
      return function (f) {
          return function (t) {
              ...
              var onFromCircle = HalogenHelpers_Coordinates.addOffset(f)(offset);
              var onToCircle = HalogenHelpers_Coordinates.subOffset(t)(offset);
          ...
          return function (to) {
              ...
              return Data_Array.fromFoldable(Data_List_Types.foldableList)(Control_Bind.bind(Data_List_Types.bindList)(from)(function (v) {
                  return Control_Bind.bind(Data_List_Types.bindList)(to)(function (v1) {
                      ...
                      throw new Error("Failed pattern match at Component.Relation line 50, column 5 - line 52, column 123: " + [ v2.constructor.name ]);
                  });
              }));
          };
      };
...
(function(exports) {
  ...
  var render = function (state) {
      ...
      return HalogenHelpers_SVG.svg([  ])([ HalogenHelpers_SVG.circle([ HalogenHelpers_SVG.cx(state.x), HalogenHelpers_SVG.cy(state.y), HalogenHelpers_SVG.r(state.r), HalogenHelpers_SVG.stroke(state.color), HalogenHelpers_SVG.class_("world world-base") ]), HalogenHelpers_SVG.text([ HalogenHelpers_SVG.stroke("black"), HalogenHelpers_SVG.x(state.x - 3 | 0), HalogenHelpers_SVG.y((state.y - state.r | 0) - 2 | 0), HalogenHelpers_SVG.class_("world-id") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state.id)) ]) ]);
  };
...
})(PS["HalogenHelpers.MouseOffset"] = PS["HalogenHelpers.MouseOffset"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var $foreign = PS["HalogenHelpers.MouseOffset"];
  var Control_Applicative = PS["Control.Applicative"];
  var Control_Bind = PS["Control.Bind"];
  var Control_Monad = PS["Control.Monad"];
  var Data_Function = PS["Data.Function"];
  ...
  var getMaybeOffset = function (v) {
      ...
      if (v instanceof Data_Maybe.Nothing) {
          return Control_Applicative.pure(Effect.applicativeEffect)(HalogenHelpers_Coordinates.noOffset);
      };
      throw new Error("Failed pattern match at HalogenHelpers.MouseOffset line 22, column 1 - line 22, column 49: " + [ v.constructor.name ]);
  };
  var getCoordinates = function (mouseEvent) {
      return function (el) {
          ...
          return function __do() {
              ...
              return HalogenHelpers_Coordinates.subOffset(coordinates)(v);
          };
      };
  };
...
(function(exports) {
  ...
  var HalogenHelpers_Coordinates = PS["HalogenHelpers.Coordinates"];
  var HalogenHelpers_MouseOffset = PS["HalogenHelpers.MouseOffset"];
  var HalogenHelpers_SVG = PS["HalogenHelpers.SVG"];
  ...
  var clickedWorlds = function (mouseEvent) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.getRef(canvasRef))(function ($162) {
          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(HalogenHelpers_MouseOffset.getCoordinates(mouseEvent)($162));
      }))(function (v) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      if (!v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.getRef(canvasRef))(function ($165) {
                              return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(HalogenHelpers_MouseOffset.getCoordinates(v.value0)($165));
                          }))(function (v4) {
              ...
              if (v1 instanceof AddingRelations) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(clickedWorlds(v.value0))(function (v2) {
                      var v3 = keyPressed(v.value0) || rightClicked(v.value0);
                      if (v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(HalogenHelpers_Communication.passAlongTo(Component_World.eqSlot)(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Component_World.Slot.create)(v2))(Component_World.RemoveRelations.create))(function (v4) {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      };
                      if (!v3) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  if (!v5) {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(HalogenHelpers_Communication.passAlongTo(Component_World.eqSlot)(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Component_World.Slot.create)(relFrom))(Component_World.AddRelation.create(relTo)))(function (v6) {
      ...
      if (v instanceof MouseMove) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.getRef(canvasRef))(function ($166) {
                  return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(HalogenHelpers_MouseOffset.getCoordinates(v.value0)($166));
              }))(function (v2) {
