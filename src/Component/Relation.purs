...
renderRelations from to =
  A.fromFoldable $ do
    ...
    case eqCoord fromCoord toCoord of
      ...
      false -> Cons (renderOtherRelation fromCoord toCoord) (L.fromFoldable $ renderArrow fromCoord toCoord)
  where
...
renderArrow f t =
  let
    ...
    classes = "relation relation-arrow"
  in
...
renderOtherRelation f t =
  ...
  in
   mkLine onFromCircle onToCircle "relation other-relation"
